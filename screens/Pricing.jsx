  ...
  return (
    <>
      ...
      <FlatList
        ...
        >
            ...
            <View style={styles.appradioButton}>
              {selectedPlan === item.id ? <View style={styles.appradioSelected} /> : null}
            </View>
          </TouchableOpacity>
        )}
      />
      ...
      <TouchableOpacity style={[
          styles.appbuyNowButton,
          selectedPlan && styles.appbuyNowButtonActive, 
        ]}>
...
<View style={styles.sparkleContainer}>
      <Image source={require("../assets/Icons/layer1.png")} style={styles.sparkle} />
    </View>
<View style={styles.sparkleContainer1}>
      <Image source={require("../assets/Icons/layer1.png")} style={styles.sparkle1} />
    </View>
<View style={styles.sparkleContainer2}>
      <Image source={require("../assets/Icons/layer1.png")} style={styles.sparkle2} />
    </View>
<View style={styles.sparkleContainer3}>
      <Image source={require("../assets/Icons/layer1.png")} style={styles.sparkle3} />
    </View>
<View style={styles.sparkleContainer4}>
      <Image source={require("../assets/Icons/layer1.png")} style={styles.sparkle4} />
    </View>
...
const styles = StyleSheet.create({
  ...
  appheartIcon:{
    ...
    appcontain: { 
      ...
      appoldPrice: {
         fontSize: 14, textDecorationLine: "line-through", color: "gray", marginLeft: 10 
        },
      appdetailsButton: {
        marginTop: 10,
