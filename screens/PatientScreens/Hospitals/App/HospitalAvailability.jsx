...
// //           <Text style={styles.slotDateTextToday}>Today</Text>
// //           <Text style={styles.slotDateText}>Tomorrow</Text>
// //           <Text style={styles.slotDateText}>Mon, 2 Feb</Text>
// //         </View>

// //         <View style={styles.slotContent}>
// //           <Text style={styles.subheading}>Morning</Text>
// //           <TouchableOpacity style={styles.slotBtn}>
// //             <Text style={styles.slotBtnText}>10:30 AM</Text>
// //           </TouchableOpacity>

// //           <Text style={styles.subheading}>Afternoon (1 slot)</Text>
// //           <TouchableOpacity style={styles.slotBtn}>
// //             <Text style={styles.slotBtnText}>12:30 PM</Text>
// //           </TouchableOpacity>
// //         </View>
