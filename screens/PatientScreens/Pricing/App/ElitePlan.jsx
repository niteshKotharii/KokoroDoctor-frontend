...
const ElitePlan = ({ navigation, route }) => {
    ...
    <View style={styles.mobileContainer}>
      ...
      <View style={styles.ContentContainer}>
        ...
        <View style={styles.planTitleContainer}>
          <Text style={styles.planTitle}>Elite Monthly Plan</Text>
        </View>
        ...
        <View style={styles.discountBanner}>
          <Text style={styles.discountText}>Save 62% ~ Limited Time Offer</Text>
        </View>
        ...
        <View style={styles.featuresContainer}>
          ...
          <View style={styles.featureItem}>
            <Text style={styles.featureBullet}>▶</Text>
            <Text style={styles.featureText}>
              VIP Access: 1 Senior Cardiologist Consultation per month (Priority
              Booking)
            </Text>
          </View>
        ...
        {/* Buy Now Button */}
        <TouchableOpacity style={styles.buyNowButton} onPress={() => {handleBuyNow(1999)}}>
