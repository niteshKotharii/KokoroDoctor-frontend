...
const ExecutivePlan = ({ navigation, route }) => {
    ...
    <View style={styles.mobileContainer}>
      ...
      <View style={styles.ContentContainer}>
        ...
        <View style={styles.planTitleContainer}>
          <Text style={styles.planTitle}>Executive Quarterly Plan</Text>
        </View>
        ...
        <View style={styles.discountBanner}>
          <Text style={styles.discountText}>Save 67% ~ Limited Time Offer</Text>
        </View>
        ...
        <View style={styles.featuresContainer}>
          ...
          <View style={styles.featureItem}>
            <Text style={styles.featureBullet}>▶</Text>
            <Text style={styles.featureText}>
              Comprehensive Heart Check-in with a Senior Cardiologist – 2 times
              per quarter (More flexibility than monthly restrictions)
            </Text>
          </View>
        ...
        {/* Buy Now Button */}
        <TouchableOpacity style={styles.buyNowButton} onPress={() => {handleBuyNow(4499)}}>
