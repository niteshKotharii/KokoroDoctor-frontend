import { View, Text, ScrollView, StyleSheet, SafeAreaView, TouchableOpacity, StatusBar, Image, Dimensions, Platform } from "react-native"
        ...
        {points.map((point, index) => (
          <View key={index} style={styles.pointRow}>
            <View style={styles.heartIcon}>
              <Image source={require("../../assets/Icons/AboutUsPoints.png")} style={styles.bulletPointsHeart}/>
            </View>
            {typeof point === "object" && point.isHighlighted ? (
              <Text style={styles.highlightedPointText}>{point.text}</Text>
            ) : (
              <Text style={styles.pointText}>{typeof point === "object" ? point.text : point}</Text>
            )}
          </View>
        ))}
      </View>
